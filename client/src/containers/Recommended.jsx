    ...
    return (
        <div className="flex flex-col bg-secondary py-4 items-center h-[650px]">
            <div className="flex flex-col items-center">
                <div className="flex flex-row items-start w-full text-left py-6">
                    <h1 className="text-white text-[32px]  font-semibold pr-2">Recommended for you</h1>
                    <div>
                ...
                <div className="flex flex-row items-between w-[1200px] space-x-5">
                    <div className="">
